...
function bb2_msie($package)
{
	...
	if (!array_key_exists('Akamai-Origin-Hop', $package['headers_mixed']) && isset($package['headers_mixed']['Connection']) && preg_match('/\bTE\b/i', $package['headers_mixed']['Connection'])) {
		return "2b90f772";
	}
